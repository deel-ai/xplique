...
from ...types import OperatorSignature, Union
...
class HadamardProjection(Projection):
    ...
    def __init__(
        self,
        model: Optional[Union[tf.keras.Model, "torch.nn.Module"]] = None,  # noqa: F821
        latent_layer: Optional[Union[str, int]] = None,
        operator: Optional[OperatorSignature] = None,
        device: Union["torch.device", str] = None,  # noqa: F821
        ...
        def get_weights(inputs, targets):
            return gradients(predictor, inputs, targets)
