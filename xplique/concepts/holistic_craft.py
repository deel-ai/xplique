...
class HolisticCraft(ABC):
    ...
    def __init__(
        self, latent_extractor: LatentExtractor, number_of_concepts: int = 20, device: str = None
    ):
    ...
    def fit(self, inputs, class_id: int = 0, max_iter: int = 200):
        """
        ...
        reducer = NMF(n_components=self.number_of_concepts, alpha_W=1e-2, max_iter=max_iter)
