...
class HolisticCraftTorch(HolisticCraft):
    ...
    def latent_to_concept_differentiable(self, latent_data: LatentData) -> torch.Tensor:
        """
        ...
        W_torch = torch.tensor(
            self.factorization.reducer.components_,
    ...
    def make_concept_decoder(self, latent_data: LatentData) -> TorchWrapper:
        ...
        torch_decoder = ConceptDecoderTorch(self, latent_data)
        wrapped_decoder = TorchWrapper(
...
class ConceptDecoderTorch(nn.Module, ConceptDecoder):
    ...
    def __init__(self, parent_craft: HolisticCraft, latent_data: LatentData) -> None:
        super().__init__()
