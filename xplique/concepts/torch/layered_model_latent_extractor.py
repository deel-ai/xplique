...
from xplique.utils_functions.classification.torch import TorchClassifierTensor
...
class LayeredLatentData(LatentData):
    ...
    def to(self, device: torch.device) -> "LayeredLatentData":
        ...
        -------
        latent_data
            New LayeredLatentData instance with data on the target device.
        """
        return LayeredLatentData(self.activations.to(device))
...
class LayeredModelExtractorBuilder(LatentExtractorBuilder):
    ...
    def build(
        ...
        **kwargs
        ...
        def h(latent_data: LayeredLatentData) -> torch.Tensor:
            """
        ...
        latent_extractor = TorchLatentExtractor(
            ...
            output_formatter=TorchClassifierTensor.from_predictions,
