...
class ConceptFactorizer(ABC):
    """
    Abstract base class for concept factorization methods used in CRAFT.
    """
    ...
    @abstractmethod
    def encode_differentiable(self, activations) -> Union[np.ndarray, Any]:
        """
    ...
    @abstractmethod
    def decode(self, coefficients) -> Union[np.ndarray, Any]:
        """
...
class SklearnNMFFactorizer(ConceptFactorizer):
    """
