...
class WhiteBoxExplainer(BlackBoxExplainer, ABC):
    ...
    harmonize
        Whether to harmonize the channel dimensions of the explanations. Default to True.
        If False, the automatic channel dimension harmonization will be disabled, preserving
        multichannel explanations as is.
    """
