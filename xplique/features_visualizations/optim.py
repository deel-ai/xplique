...
from ..commons.model_override import open_relu_policy, override_relu_gradient
from ..types import Callable, List, Optional, Tuple, Union
from .objectives import Objective
from .preconditioning import fft_image, fft_to_rgb, get_fft_scale, to_valid_grayscale, to_valid_rgb
...
def optimize(
    ...
    if use_fft:
        ...
        def image_param(inputs):
            return to_valid_image(inputs, image_normalizer, values_range)
