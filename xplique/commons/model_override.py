...
def guided_relu_policy(max_value: Optional[float] = None, threshold: float = 0.0) -> Callable:
    """
...
def deconv_relu_policy(max_value: Optional[float] = None, threshold: float = 0.0) -> Callable:
    """
...
def open_relu_policy(max_value: Optional[float] = None, threshold: float = 0.0) -> Callable:
    """
