...
class TorchBoxesModelWrapper(OutputAsListMixin, torch.nn.Module, ABC):
    ...
    def __init__(self, model: torch.nn.Module, box_formatter: TorchBaseBoxFormatter) -> None:
        """
        ...
        self.eval()  # Set training to False by default

    def forward(self, x: torch.Tensor, **kwargs) -> Union[torch.Tensor, List[TorchMultiBoxTensor]]:
        """
