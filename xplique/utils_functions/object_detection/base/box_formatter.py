"""
Base classes for formatting object detection predictions.
"""
...
from .multi_box_tensor import BaseMultiBoxTensor
...
class BaseBoxFormatter(ABC):
    ...
    def __call__(self, predictions: Any) -> BaseMultiBoxTensor:
        """
    ...
    @abstractmethod
    def forward(self, predictions: Any) -> BaseMultiBoxTensor:
        """
