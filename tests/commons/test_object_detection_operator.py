...
def test_all_object_detector_operators():
    ...
    # create operators
    normal_op = lambda model, inputs, targets: object_detection_operator(
        model, inputs, targets, **parameters_normal
    )

    intersection_op = lambda model, inputs, targets: object_detection_operator(
        model, inputs, targets, **parameters_intersection
    )

    probability_op = lambda model, inputs, targets: object_detection_operator(
        model, inputs, targets, **parameters_probability
    )

    classification_op = lambda model, inputs, targets: object_detection_operator(
        model, inputs, targets, **parameters_classification
    )
